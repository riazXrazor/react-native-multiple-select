    ...
    return (
      <TouchableOpacity
        ...
        style={[
          ...
          { paddingLeft: 20, paddingRight: 20, borderBottomWidth:1, borderBottomColor:"#ccc" }
        ]}
      >
        <View>
    ...
    return (
      ...
      >
        {selector ? (
          ...
          >
            <View
              style={[styles.inputGroup, styleInputGroup && styleInputGroup,{borderWidth:1, borderColor:"#ccc", borderBottomWidth:2}]}
            >
              {searchIcon}
              <TextInput
                autoFocus
            ...
            >
              ...
              {!single && !hideSubmitButton && (
                <TouchableOpacity
                  ...
                  style={[
                    styles.button,
                    { backgroundColor: submitButtonColor, alignSelf:'center', paddingHorizontal:30, borderRadius:20 }
                  ]}
                >
                  <Text
                    style={[
          ...
          <View>
            ...
            >
              <View
                style={[
                  styles.subSection,
                  { paddingTop: 5, paddingBottom: 5, paddingLeft: 10, borderWidth:1, borderColor:"#ccc" },
                ...
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Icon
                      ...
                      style={[styles.indicator,{left:13}]}
                    />
                  </View>
                </TouchableWithoutFeedback>
              </View>
